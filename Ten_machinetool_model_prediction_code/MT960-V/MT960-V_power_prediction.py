...
def spindle(s):
    if s== 0.0:
        ...
        ps= (3.29*10**-5*s**2)-(0.25*s)+733
        return ps
    elif   4000 <= s:
        ps= (6.25*10**-6*s**2)-(0.05*s)+370
        return ps
...
file_path = 'MT960-Vparternpoerdata.xlsx'  
...
plt.step(x, y, linestyle='--', color='darkred',linewidth=2.5, label='Preditcion')
...
plt.title('MT-960V',fontsize=28, fontname='Arial')
