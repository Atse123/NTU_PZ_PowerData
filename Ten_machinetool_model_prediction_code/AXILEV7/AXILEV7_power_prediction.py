...
def spindle(s):
    if s== 0.0:
        ...
        ps= 156.4+(0.038)*s+(1.43*10**-6)*s**2
        return ps
    elif   7000 <= s:
        ps= 672.14+(-0.056)*s+(4.19*10**-6)*s**2
        return ps
...
file_path = 'AXILEV7pattern_measuermentpowerdata.xlsx'  
...
plt.title('AXILEV7',fontsize=28, fontname='Arial')
