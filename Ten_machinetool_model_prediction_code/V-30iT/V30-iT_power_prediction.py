...
def spindle(s):
    if s== 0.0:
        ...
        ps= (1.73*10**-5)*s**2-0.05*s+328.38
        return ps
    elif   4500 < s:
        ps= (1.02*10**-5)*s**2-0.035*s+573.03
        return ps
...
file_path = 'V-30ITpattern_measuermentpowerdata.xlsx'  
...
plt.title('V30-iT',fontsize=28, fontname='Arial')
