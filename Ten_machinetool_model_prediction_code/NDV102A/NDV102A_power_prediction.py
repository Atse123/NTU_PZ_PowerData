...
P_stanby =665  #Auxiliary systems increase standby energy consumption
...
def spindle(s):
    if s== 0.0:
        ...
        ps= (1.3*10**-4*s**2)-(0.74*s)+1342.59
        return ps
    elif   3500 <= s:
        ps= (1.37*10**-5*s**2)-(0.12*s)+606.35
        return ps
...
file_path = 'NDV102Apattern_measuermentpowerdata.xlsx'  
...
plt.title('NDV102A',fontsize=28, fontname='Arial')
